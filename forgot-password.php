...
<html lang="en">
    <head>
        ...
        <title>Forgot Password | YourQS</title>
        <meta name="description" content="Forgot Password? Enter email and registration code to get your password on your email.">
    ...
    <body id="page-top" onload="clearAll()" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="container" id="forgotPassword"><br class="visible-xs visible-sm visible-md"><br class="visible-xs visible-sm visible-md">
            <div class="section-title">
                <h2 class="section-group-heading">Forgot Password</h2>
            </div>
            <form name="forgotPassword" method="post" action="forgot-password.php">
                <p>Enter your registered email and get your password through email.</p><br>
                <?php
                if (!empty($forgotPasswordErrorMsg)) {
                    echo '<div class="alert alert-danger" id="verifyErrorMsg"><strong>' . $forgotPasswordErrorMsg . '</strong></div>';
                }
                ?>
                <?php
                if (!empty($forgotPasswordSuccessMsg)) {
                    echo '<div class="alert alert-success" id="verifySuccessMsg"><strong>' . $forgotPasswordSuccessMsg . '</strong></div>';
                }
                ?>
                <div class="row">
                    <div class="form-group col-xs-12 col-sm-4">
                        <div class="input-group ">
                            ...
                            <input type="email" name="recoveryEmail" class="form-control" aria-label="Email" placeholder="Enter your registered email" required="required">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-xs-12 col-sm-4">
                        <div class="input-group ">
                            ...
                            <input type="number" name="regCode" class="form-control" aria-label="Registration Code" placeholder="Enter your registration code" required="required">
                        </div>
                    </div>
                </div><br>
                <div class="form-group">
                    <button type="submit" name="btnSendPassword" id="btnSendPassword" class="btn btn-danger btn-responsive"><strong>Send Password</strong></button>
                </div>
            </form>
        </div><br><br>
        <!-- Contact Section -->
                    ...
                    <div class="row">
                        ...
                        <form name="contact" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>#contact">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="email" name="contactEmail" class="form-control" placeholder="Registered Email" required="required">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                </div>
                            </div>
